...
curl -x 127.0.0.1:8888 -v -u%3:%4 -X POST -d "<entry><id/><title/><updated/><payload><digest/></payload></entry>" http://localhost:%1/sdata/billingboss/crmErp/-/%5/$syncSource?trackingId=%2&runName=%5&runStamp=2010-10-14T08:51:02
...
REM get all customers
curl -x 127.0.0.1:8888 -v -u%3:%4 http://localhost:%1/sdata/billingboss/crmErp/-/%5?select=name,customerSupplierFlag
...
REM create sync request
curl -x 127.0.0.1:8888 -v -u%3:%4 -X POST -d "<entry><id/><title/><updated/><payload><digest/></payload></entry>" http://localhost:%1/sdata/billingboss/crmErp/-/%5/$syncSource?trackingId=%2&runName=customers&runStamp=2010-10-14T08:51:02
