...
curl -v -u%3:%4 -X POST -d @C:\Python26\%1\link_post_request.xml -H "Content-Type: text/xml; charset=utf-8" http://localhost:%1/sdata/billingboss/crmErp/-/%5/$linked
...
curl -v -u%3:%4 -X POST -d @C:\Python26\%1\link_post_request.xml -H "Content-Type: text/xml; charset=utf-8" http://localhost:%1/sdata/billingboss/crmErp/-/%5/$linked
curl -v -u%3:%4 -X POST -d @C:\Python26\%1\link_post_request_1.xml -H "Content-Type: text/xml; charset=utf-8" http://localhost:%1/sdata/billingboss/crmErp/-/%5/$linked
...
curl -v -u%3:%4 -X POST -d @C:\Python26\%1\link_post_request.xml http://localhost:%1/sdata/billingboss/crmErp/-/%5/$linked
curl -v -u%3:%4 -X POST -d @C:\Python26\%1\link_post_request_1.xml http://localhost:%1/sdata/billingboss/crmErp/-/%5/$linked
curl -v -u%3:%4 -X POST -d @C:\Python26\%1\link_post_request_2.xml http://localhost:%1/sdata/billingboss/crmErp/-/%5/$linked
curl -v -u%3:%4 -X POST -d @C:\Python26\%1\link_post_request_3.xml http://localhost:%1/sdata/billingboss/crmErp/-/%5/$linked
curl -v -u%3:%4 -X POST -d @C:\Python26\%1\link_post_request_4.xml http://localhost:%1/sdata/billingboss/crmErp/-/%5/$linked
